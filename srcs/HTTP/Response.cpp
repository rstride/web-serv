...
// Check if the extension is a CGI
...
// Build the error page for the given status code
...
// Build the list of accepted methods
...
// Handle localization based on Accept-Language header
...
// Handle charset based on Accept-Charset header
